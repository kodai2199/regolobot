...
class MyRobot:
    ...
    def __init__(self, Group_Name):
        ...
        rospy.loginfo(
            "\033[95m" + "Planning Group: {}".format(self._planning_frame) + "\033[0m"
        )
        rospy.loginfo(
            "\033[95m" + "End Effector Link: {}".format(self._eef_link) + "\033[0m"
        )
        rospy.loginfo(
            "\033[95m" + "Group Names: {}".format(self._group_names) + "\033[0m"
        )
        rospy.loginfo("\033[95m" + " >>> MyRobot initialization is done." + "\033[0m")

    def set_pose(self, arg_pose_name):
        rospy.loginfo(
            "\033[32m" + "Going to Pose: {}".format(arg_pose_name) + "\033[0m"
        )
