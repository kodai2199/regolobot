...
BASE_FILE_PATH = "/home/ros/ws_moveit/src/regolobot/models/regolo"
...
def loop():
    ...
    stick_manager = MathStickManager(spawn_model_proxy, delete_model_proxy, 10, BASE_FILE_PATH, **boundaries)
